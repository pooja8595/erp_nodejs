module.exports = (sequelize, Sequelize) => {
    const cpProvisionPaymentDetailsModel = sequelize.define("channel_partner_provision_payment", {
      channel_partner_provision_id: {
      ...
      status: {
        type: Sequelize.ENUM("RBH APPROVED", "RBH REJECTED", "VERIFIED", "YET TO APPROVED", "SENT FOR RBH HEAD APPROVAL"),
        defaultValue: "YET TO APPROVED",
      },
    });
    return cpProvisionPaymentDetailsModel;
  };